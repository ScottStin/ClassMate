...
export const menuItems: MenuItemDTO[] = [
  ...
  },
  {
    ...
    adminName: 'Classes',
    use: ['teacher', 'student', 'school', 'school'],
    icon: 'class',
    routerLink: '/lessons',
  ...
  },
  {
    ...
    breadcrumb: 'teachers',
    headerButton: 'Add New Teacher', // bug - for some reason the admin/teacher version of the teacher page (colleagues) isn't displaying the ad button, so we've had to add it here.
    headerButtonIcon: 'add',
